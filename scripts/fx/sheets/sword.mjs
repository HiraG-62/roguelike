...
import { DIRS, arcSheet, arcSlash } from "../motifs.mjs";
...
/**
 * 武器種のモーション → シート（render/fxMotions.ts が読む）。key は l:<段> / r:<右の段の key> / branch:<派生の key> / dash / charge。
 * pivot: self = 自分の中心、anchor = 当たり判定の中心。base は絵を描いたときの当たり判定の大きさ（measure の値。論理 px）
 */
const FX = {
  moveset: "sword",
  motions: {
    "l:0": { sheet: "sword.l1", pivot: "self", base: 16, measure: "reach" },
    "l:1": { sheet: "sword.l2", pivot: "self", base: 18, measure: "reach" },
    "l:2": { sheet: "sword.l3", pivot: "self", base: 22, measure: "reach" },
    dash: { sheet: "sword.dash", pivot: "self", base: 26, measure: "reach" },
    "r:returnCut": { sheet: "sword.thrust", pivot: "self", base: 30, measure: "reach" },
    "r:risingCut": { sheet: "sword.rising", pivot: "self", base: 26, measure: "reach" },
    "branch:crossCut": { sheet: "sword.cross", pivot: "anchor", base: 22, measure: "reach" },
    "branch:steppingCut": { sheet: "sword.step", pivot: "self", base: 30, measure: "reach" },
    "branch:tomoe": { sheet: "sword.tomoe", pivot: "anchor", base: 44, measure: "size" },
    "branch:reverseKesa": { sheet: "sword.kesa", pivot: "anchor", base: 22, measure: "reach" },
  },
  hit: "sword.hit",
