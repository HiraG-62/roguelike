...
/**
 * 大きく回り込む弧（振り幅 180° 以上）と 1 周する振りの方向の数（30° 刻み）。
 * 面積の大きいシートなので 24 方向ではアトラスが 100MB 近くなる。回り込む弧は向きの誤差が目立たない。
 * 12 も 0 を含む偶数なので、反時計回りの上下反転（−θ の絵）の組はそろう
 */
export const WIDE_DIRS = 12;
/** これ以上の振り幅（度）の弧は WIDE_DIRS で描く */
export const WIDE_SWEEP = 180;
