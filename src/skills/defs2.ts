...
export const WAVE2_SKILL_DEFS: Record<Wave2SkillKey, SkillDef> = {
  ...
  brandSear: {
    ...
    name: "焼き印",
    icon: "印",
    verb: "前方を焼きつけて烙印 2 を刻む（射撃・スキルの命中で起爆する）",
    tags: ["melee", "fire"],
  ...
  collapseHammer: {
    ...
    name: "崩落槌",
    icon: "崩",
    verb: "前方を叩く。崩勢中の敵はその場で怯む（崩勢で長く、解けても堅守が付かない）",
    tags: ["melee", "area"],
  ...
  siphonMark: {
    ...
    name: "吸魔の矢",
    icon: "魔",
    verb: "当てた敵に吸魔を付ける（その敵への命中で気力が戻り、倒すと残りの秒ぶん戻る）",
    tags: ["projectile"],
  ...
  doomSentence: {
    ...
    name: "死の宣告",
    icon: "宣",
    verb: "カーソル近くの敵とその周りに宣告。切れたとき、付けてから減った生命の一部をまとめて与える",
    tags: ["area"],
  ...
  weaponArt: {
    ...
    name: "極意",
    icon: "極",
    verb: "装備中の武器種で形が変わる大技（剣 十文字 / 槍 槍衾 / 鞭 先端打ち / 杖 魔弾 …）。属性は武器に揃う",
    tags: ["melee", "area"],
