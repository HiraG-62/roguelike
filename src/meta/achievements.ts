...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  { key: "fiftyRuns", name: "古参", desc: "探索を 50 回終える。", check: (c) => c.meta.runs >= 50 },
  ...
  { key: "biomeAll", name: "旅人", desc: "すべての種類の階を訪れる。", check: (c) => FLOOR_KINDS.every((k) => c.codex.floorKinds.includes(k)) },
  ...
  { key: "quest10", name: "請負人", desc: "依頼を 10 件達成する。", check: (c) => completedQuestCount(c.quests) >= 10 },
