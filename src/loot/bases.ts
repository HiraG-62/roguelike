...
export const BASES: readonly BaseItemDef[] = [
  ...
  { key: "twinblades", name: "Twinblades", slot: "weapon", minLevel: 6, implicitKey: "implicit.twinblades" },
  { key: "warpick", name: "War Pick", slot: "weapon", minLevel: 13, implicitKey: "implicit.warpick" },
  ...
  { key: "revolver", name: "Revolver", slot: "gun", minLevel: 7, implicitKey: "implicit.revolver" },
  { key: "railgun", name: "Railgun", slot: "gun", minLevel: 16, implicitKey: "implicit.railgun" },
  ...
  { key: "berserkerHide", name: "Berserker Hide", slot: "armor", minLevel: 6, implicitKey: "implicit.berserkerHide" },
  ...
  { key: "lungingBoots", name: "Lunging Boots", slot: "boots", minLevel: 7, implicitKey: "implicit.lungingBoots" },
  ...
  { key: "voidBand", name: "Void Band", slot: "ring", minLevel: 13, implicitKey: "implicit.voidBand" },
  ...
  { key: "duskAmulet", name: "Dusk Amulet", slot: "amulet", minLevel: 9, implicitKey: "implicit.duskAmulet" },
];
