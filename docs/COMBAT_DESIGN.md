...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `whirl` | 旋風斬り | 気力 | 18 | 0.6 | - | 3 + 筋 0.4 + 霊 0.4（1 回転ヒット） | 7 × 4 | 6 / ヒット | - |
| `lunge` | 突進斬り | 再使用 | 0 | 0.3 | 3.0 | 8 + 筋 1.0 + 技 0.6 | 16 | 20 | - |
| `frag` | グレネード | 気力 | 22 | 0.5 | - | 12 + 技 1.4 + 霊 1.4 | 26 | 30 | - |
| `railshot` | 撃ち抜き | 気力 | 25 | 0.8 | - | 14 + 技 2.0 + 霊 1.2 | 30 | 25 | 脆弱 3 秒 |
