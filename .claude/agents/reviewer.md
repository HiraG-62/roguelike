...
- **整合**: 型の Record 漏れ、`noUncheckedIndexedAccess` の undefined 握りつぶし、数値の直書き（`src/data/balance/**/*.json` に無い）、`ctx.fillText` / `measureText` の直接使用、表示文字列の用語揺れと文の形の浮き文字（`docs/GLOSSARY.md`）
